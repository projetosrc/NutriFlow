...
//  Tela de Café da Manhã — NutriFlow
//
//  MUDANÇA: toque no card do alimento abre o EditarGramasSheet
//  para editar a quantidade em gramas, recalculando os macros.
//  Deslize para esquerda continua removendo o item.
// =============================================================
...
class CafeDaManhaScreen extends StatelessWidget {
  ...
  static const String _nomeRefeicao = 'Café da Manhã';
  static const String _timeRange    = '06:00 - 09:00';
  static const Color  _iconColor    = Color(0xFFF4A261);
  static const Color  _iconBgColor  = Color(0xFFFFF0E0);
  static const Color  _kTeal        = Colors.teal;

  @override
  Widget build(BuildContext context) {
    final uid   = FirebaseAuth.instance.currentUser?.uid;
    final docId = '${uid}_Café_da_Manhã';
    ...
    return Dismissible(
      ...
      confirmDismiss: (_) async => await showDialog<bool>(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: Text('Remover "${d['nome']}" do Café da Manhã?'),
          actions: [
            TextButton(
      ...
      onDismissed: (_) async {
        await docRef.delete();
        // Recalcula totais dos itens restantes para evitar valores negativos
