...
class _PerfilPageState extends State<PerfilPage> {
  ...
  void initState() {
    super.initState();
    final user = _user;
    // Guarda de nulo (DEF-002): sem sessão ativa, redireciona ao login
    // após o primeiro frame em vez de fazer force-unwrap e crashar.
    if (user == null) {
  ...
  Widget build(BuildContext context) {
    // Sem usuário autenticado, o redirect já foi agendado no initState;
    // mostramos apenas um loading até a navegação ocorrer (DEF-002).
    if (_user == null) {
