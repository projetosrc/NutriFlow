...
class _AdicionarAlimentoScreenState extends State<AdicionarAlimentoScreen> {
  ...
  Future<void> _adicionarAlimento(Map<String, dynamic> alimento) async {
    ...
    try {
      ...
      // Inserção do item + atualização dos totais de forma atômica (DEF-008):
      // o item só é criado se os totais também forem atualizados.
      final itemRef = refeicaoRef.collection('itens').doc();
