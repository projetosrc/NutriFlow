...
class JantarScreen extends StatelessWidget {
  ...
  static const String _nomeRefeicao = 'Jantar';
  static const String _timeRange    = '18:00 - 21:00';
  static const Color  _iconColor    = Color(0xFF7C83FD);
    ...
    return Dismissible(
      ...
      confirmDismiss: (_) async => await showDialog<bool>(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: Text('Remover "${d['nome']}" do Jantar?'),
          actions: [
            TextButton(
