...
class _EditarGramasSheetState extends State<EditarGramasSheet> {
  ...
  Future<void> _salvar() async {
    ...
    try {
      ...
      // A diferença a aplicar nos totais do documento pai
      ...
      // Atualiza o item E os totais do pai de forma atômica (DEF-008): ou
      // ambos são gravados, ou nenhum — evita totais dessincronizados.
      final batch = FirebaseFirestore.instance.batch();

      // 1. Atualiza o item
      batch.update(widget.docRef, {
        'porcao':   '${_gramas}g',
